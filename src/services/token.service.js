 ...
 * @returns {string}
 */
const generateToken = (userId, expires, type, metaData, secret = config.jwt.secret) => {
  const payload = {
    sub: userId,
    meta: metaData,
    iat: moment().unix(),
...
const generateResetPasswordToken = async (email) => {
  ...
  const resetPasswordToken = generateToken(user.id, expires, tokenTypes.RESET_PASSWORD, { email });
